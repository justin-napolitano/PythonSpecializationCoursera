...
data_structure = []
project_folder = '/Users/jnapolitano/Dropbox/Personal/Portfolio/Coursera/PythonProgrammingSpeciializationCoursera/Course5/'
small = 'small_img.zip'
large = 'images.zip'

def append_images():
    with zipfile.ZipFile(project_folder + small, 'r') as f:   #Open the Archive
